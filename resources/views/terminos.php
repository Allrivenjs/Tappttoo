...
<html>
  ...
  <body>
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Inversiones
      JRDM.
    </p>
    <p>
      Inversiones JRDM is committed to ensuring that the app is as useful and
    ...
    <p>
      The Tappttoo app stores and processes personal data that you have provided
      to us, to provide our Service. It’s your responsibility to keep your phone
      ...
      features and it could mean that the Tappttoo app won’t work properly or at
      all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Inversiones JRDM
      ...
      be Wi-Fi or provided by your mobile network provider, but Inversiones JRDM
    ...
    <p>
      Along the same lines, Inversiones JRDM cannot always take responsibility
      ...
      avail the Service, Inversiones JRDM cannot accept responsibility.
    </p>
    <p>
      With respect to Inversiones JRDM’s responsibility for your use of the app,
      ...
      available to you. Inversiones JRDM accepts no liability for any loss,
    ...
    <p>
      ...
      keep using the app. Inversiones JRDM does not promise that it will always
    ...
    <p>These terms and conditions are effective as of 2023-02-03</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about our Terms and Conditions,
      do not hesitate to contact us at tappttoo.col@gmail.com.
    </p>
    <p>
